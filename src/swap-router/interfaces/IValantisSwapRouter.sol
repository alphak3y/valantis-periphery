...
import {ISovereignPoolSwapCallback} from "../../../lib/valantis-core/src/pools/interfaces/ISovereignPoolSwapCallback.sol";
import {IUniversalPoolSwapCallback} from "../../../lib/valantis-core/src/pools/interfaces/IUniversalPoolSwapCallback.sol";

import {GaslessSwapParams, DirectSwapParams} from "../structs/ValantisSwapRouterStructs.sol";

interface IValantisSwapRouter is
